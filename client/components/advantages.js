...
import '../css/mainpage/advantages.sass';
		...
		return (
			<div className="advantages">
				...
				<div className="advantages__container">
					...
					<div><i className="fa fa-star fa-4x" aria-hidden="true"></i><span>Опыт</span><p>Более 7 лет опыта <br /> и 1000 довольных <br /> клиентов</p></div>
				</div>
			</div>
		)
	}	
